...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=ZVLAPTOP-CZUNIG\\SQLDEV2017 ;Database=RentaCar; persist security info=True; user ID=sa;Password=stone015;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<TAgente>(entity =>
            {
                ...
                entity.HasOne(d => d.IdBaseNavigation)
                    ...
                    .HasConstraintName("FK__t_Agente__idBase__44FF419A");
            });
            ...
            modelBuilder.Entity<TAuto>(entity =>
            {
                ...
                entity.HasOne(d => d.IdBaseNavigation)
                    ...
                    .HasForeignKey(d => d.IdBase)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__t_Auto__idBase__440B1D61");
            });
            ...
            modelBuilder.Entity<TMecanico>(entity =>
            {
                ...
                entity.HasOne(d => d.IdBaseNavigation)
                    ...
                    .HasForeignKey(d => d.IdBase)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__t_Mecanic__idBas__47DBAE45");
            });
            ...
            modelBuilder.Entity<TOrden>(entity =>
            {
                ...
                entity.HasOne(d => d.IdAutoNavigation)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__t_Orden__idAuto__49C3F6B7");

                entity.HasOne(d => d.IdClienteNavigation)
                    .WithMany(p => p.TOrden)
                    .HasForeignKey(d => d.IdCliente)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__t_Orden__idClien__48CFD27E");
            });
            ...
            modelBuilder.Entity<TReparacion>(entity =>
            {
                ...
                entity.HasOne(d => d.IdAutoNavigation)
                    ...
                    .HasForeignKey(d => d.IdAuto)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__t_Reparac__idAut__45F365D3");

                entity.HasOne(d => d.IdMecanicoNavigation)
                    .WithMany(p => p.TReparacion)
                    .HasForeignKey(d => d.IdMecanico)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__t_Reparac__idMec__46E78A0C");
            });
